...
public class StringBuilderCalcEngine {
    ...
    private static void printResult(char opCode, double leftVal, double rightVal, double result) {
        char symbol = opCodeToSymbol(opCode);
        StringBuilder message = new StringBuilder();
        message.append(leftVal).append(" ").append(symbol).append(" ").append(rightVal).append(" = ").append(result);
        String resultToPrint = message.toString();
        System.out.println(resultToPrint);
    }

    static char opCodeToSymbol(char opcode){
